...
sap.ui.define([
		...
		"sap/ui/Device",
		"salesorders/model/formatter",
		"salesorders/model/grouper",
		"salesorders/model/GroupSortState"
	], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, grouper, GroupSortState) {
		"use strict";

		return BaseController.extend("salesorders.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("salesorders.view.ViewSettingsDialog", this);
