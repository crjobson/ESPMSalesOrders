sap.ui.define([
		...
		return BaseObject.extend("salesorders.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias salesorders.model.ListSelector
			 */
			 ...
			 * @return {salesorders.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
