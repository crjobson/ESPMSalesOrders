							...
							success : function (aEntityData) {
								this.waitFor({
									...
									success : function (oList) {
										...
										oCurrentItem.bindingPath = "/" + oList.getModel().createKey("SalesOrderHeaders", {
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "<SalesOrderHeaders> (0)"}),
							success : function () {
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all SalesOrderHeaders to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "<SalesOrderHeaders> (" + iExpectedLength + ")"}),
									success : function () {
